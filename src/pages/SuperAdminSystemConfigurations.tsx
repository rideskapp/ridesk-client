...
const SuperAdminSystemConfigurations: React.FC = () => {
  ...
  useEffect(() => {
    if (selectedSchoolId && location.pathname === "/admin/system-configurations") {
  ...
  if (!selectedSchoolId) {
    return (
      <div className="py-4">
        <h1 className="text-2xl font-semibold mb-4">{t("systemConfig.systemConfigurations")}</h1>
        <Card>
                    ...
                    <tr key={s.id}>
                      ...
                      <td className="px-4 py-2 whitespace-nowrap text-right">
                        <Button asChild size="sm" variant="outline">
                          <Link to={`/admin/system-configurations/${s.id}`}>
                            <Settings className="h-4 w-4 mr-2" />
                            {t("systemConfig.manageConfiguration")}
                          </Link>
                        </Button>
                      </td>
                    </tr>
...
export default SuperAdminSystemConfigurations;
