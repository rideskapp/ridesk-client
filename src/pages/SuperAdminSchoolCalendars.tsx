...
const SuperAdminSchoolCalendars: React.FC = () => {
  ...
  useEffect(() => {
    if (selectedSchoolId && location.pathname === "/admin/school-calendars") {
      navigate(`/admin/school-calendars/${selectedSchoolId}`, { replace: true });
    }
  }, [selectedSchoolId, location.pathname, navigate]);
  ...
  if (!selectedSchoolId) {
    return (
      <div className="py-4">
        <h1 className="text-2xl font-semibold mb-4">{t("schoolCalendar.schoolCalendars")}</h1>
        <Card>
                ...
                {loading ? (
                  <tr>
                    <td colSpan={4} className="px-4 py-6 text-center">
                      <div className="flex justify-center items-center">
                        ...
                        <span className="ml-3 text-sm text-gray-500">{t("schoolCalendar.loading")}</span>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colSpan={4} className="px-4 py-6 text-center text-sm text-gray-500">
                      {t("schoolCalendar.noSchoolsFound")}
                    </td>
                  </tr>
                ) : (
                    ...
                    <tr key={s.id}>
                      ...
                      <td className="px-4 py-2 whitespace-nowrap text-right">
                        <Button asChild size="sm" variant="outline">
                          <Link to={`/admin/school-calendars/${s.id}`}>
                            <Calendar className="h-4 w-4 mr-2" />
                            {t("schoolCalendar.manageCalendar")}
                          </Link>
                        </Button>
                      </td>
                    </tr>
...
export default SuperAdminSchoolCalendars;
